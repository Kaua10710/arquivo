        ...
        switch (opcaoMenu) {
            ...
            case 2: 
                ...
                while (continuar == "S" || continuar == "s"){    
                    ...
                    if (!existencia){
                        cout << "Este codigo não foi encontrado em nosso banco de dados. ";
                        cin.get();
                        cout << "\e[2J" << "\e[0;0H";
                    }
                    fclose(dadosLivros);

                    cout << "\nDeseja realizar mais uma alteração? S ou N: ";
                    cin >> continuar; 
                    cin.ignore(numeric_limits<streamsize>::max(), '\n');
                }
                cin.ignore();
            ...
            case 3:
                ...
                while (continuar == "S" || continuar == "s"){
                    cout << "Informe o código do livro que deseja excluir: " << endl << endl;
                    cin >> codigoConsulta;
            ...
            // devolução dos livros utilizados
            case 5:
                cout << "\e[2J" << "\e[0;0H";
                cout << "DEVOLUCAO: \n\n";
                ...
                while (continuar == "S" || continuar == "s"){
                    ...
                    while(!feof(dadosLivros)){
                        ...
                        if ((livrosDisponiveis.codigoCatalogo == codigoConsulta)&& (strcmp(livrosDisponiveis.emprestimoLivro.sitacaoEmprestimo, "Indisponivel") == 0)){
                            ...
                            cout << "\nFalha na devolução, este livro já estava disponível para empréstimo!\n";
                            cin.get();
                            cout << "\e[2J" << "\e[0;0H";
                            existencia = true;
                            break; 
                    ...
                    if (!existencia){
                        cout << "Este codigo não foi encontrado no nosso banco de dados.";
                        cin.get();
                        cout << "\e[2J" << "\e[0;0H";
                    }
                    fclose(dadosLivros);
                    cout << "\nDeseja realizar mais uma devolução? S ou N: ";
                    cin >> continuar; 
                    cin.ignore(numeric_limits<streamsize>::max(), '\n');
                }
            ...
            case 6:
                ...
                while(continuar == "S" || continuar == "s"){
                    cout << "Digite o código do livro para iniciar a consulta: " << endl;
                    cin >> codigoConsulta;
                    ...
                    if (!existencia){
                        cout << "Este código não foi encontrado no nosso banco de dados. ";
                        cin.get();
                        cout << "\e[2J" << "\e[0;0H";
                    }
            ...
            // listagem livros disponiveis para empréstimo
            case 7:
                cout << "\e[2J" << "\e[0;0H";
                cout << "LIVROS DISPONIVEIS PARA EMPRESTIMO: \n\n";
                cout << "Estes são os livros presentes em nossa biblioteca, disponíveis para emprestimo: " << endl << endl;    
            ...
            case 8:
                ...
                cout << "Estes são os livros presentes em nossa biblioteca: " << endl << endl;    
                ...
                while(!feof(dadosLivros)){
                    ...
                    cout << "Editora = " << livrosDisponiveis.editoraLivro << endl;
                    cout << "Numero de paginas = "<< livrosDisponiveis.numeroPaginas << endl;
                    cout << "Situação de emprestimo = " << livrosDisponiveis.emprestimoLivro.sitacaoEmprestimo << endl;
                    cout << "---------------------------------------------------" << endl;
                    fread(&livrosDisponiveis, sizeof(struct livro), 1, dadosLivros);
                };
                fclose (dadosLivros);
            ...
            // saída
            case 9: 
                cout << "\n Obrigado por usar o sistema, utilize sempre que precisar !";
                cin.ignore();
                cin.get();
                break;

            //caso não digite algo coerente
            default:
                cout << "\e[2J" << "\e[0;0H";
